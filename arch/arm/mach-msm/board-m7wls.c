...
static void __init m7wls_reserve(void)
{
	if (mem_size_mb == 64)
		return;
...
static void __init m7wls_early_reserve(void)
{
...
static void __init m7wls_map_io(void)
{
...
static void __init m7wls_init_irq(void)
{
...
static void __init m7wls_common_init(void)
{
	int rc = 0;
...
static void __init m7wls_allocate_memory_regions(void)
{
	m7wl_allocate_fb_region();
}

static void __init m7wls_cdp_init(void)
{
...
static void __init m7wls_fixup(struct tag *tags, char **cmdline, struct meminfo *mi)
{
...
MACHINE_START(M7_WLS, "UNKNOWN")
	.fixup = m7wls_fixup,
	.map_io = m7wls_map_io,
	.reserve = m7wls_reserve,
	.init_irq = m7wls_init_irq,
	.handle_irq = gic_handle_irq,
	.timer = &msm_timer,
	.init_machine = m7wls_cdp_init,
	.init_early = m7wls_allocate_memory_regions,
	.init_very_early = m7wls_early_reserve,
	.restart = msm_restart,
MACHINE_END
