...
static struct mmc_platform_data *m7wl_sdc3_pdata = &sdc3_data;
#else
static struct mmc_platform_data *m7wl_sdc3_pdata;
#endif
#endif
...
void __init m7wl_init_mmc(void)
{
	wifi_status_cb = NULL;

	printk(KERN_INFO "m7wl: %s\n", __func__);
